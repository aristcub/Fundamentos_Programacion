...
public class EjercicioEstrella {
    public static void main(String [] Args) throws IOException {
        ...
        //String rutaJumbo = "https://www.tiendasjumbo.co/tecnologia/televisores-y-video/televisores";
        ...
        //LOS CODIGOS EN AZUL FUERON INTENTOS FALLIDOS, DESDE ACA EMPIEZA EL VERDADERO PROGRAMA
        ...
        int i = 1;
        String s0 = codigoFuente;
        String s1 = codigoFuente;
        String s2 = codigoFuente;
        ...
        while(codigoFuente.length()>0 || i == 0) {
            ...
            if(i>0) {
                ...
                int j = codigoFuente.indexOf(keyPrecio1, i);
                String precio = codigoFuente.substring(i, j);
                System.out.println(cont + ".- "+precio);
